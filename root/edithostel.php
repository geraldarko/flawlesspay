...
<body>
    ...
    <form action= "../actions/update_hostel.php" method="POST">
        ...
        <h4>Hostel Slogan</h4>
        <textarea type="text" name="editedhostelslogan" id="editedslogan" cols="40" rows="5" 
        ><?php
            $selectone=selectAHostel_ctr($gethostelID); 
            if ($selectone == NULL){
            print ("Doesnt exist.");
        ...
        <textarea type="text" name="editedhosteldescription" id="editeddescription" cols="40" rows="5"
        ><?php
            $selectone=selectAHostel_ctr($gethostelID); 
            if ($selectone == NULL){
            print ("Doesnt exist.");
                ...
                print $selectone['hostel_description'];
            }
        ?> 
        </textarea>
