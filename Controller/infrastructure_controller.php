...
include("../classes/infrastructure_class.php");
...
//--INSERT ROOM ctr--//
function addRoom_ctr($hostelID,$roomName,$roomType,$roomGender,$roomCap){
    $addItem= new infrastructure_class();

    $addItem->addRoom_cls($hostelID,$roomName,$roomType,$roomGender,$roomCap);
    return $addItem;
}
...
//--update ROOM ctr--//
function updateRoom_ctr($editedName,$editedType,$editedGender,$editedCap,$roomID){
    $updateItem= new infrastructure_class();

    return $updateItem->updateRoom_cls($editedName,$editedType,$editedGender,$editedCap,$roomID);
}
