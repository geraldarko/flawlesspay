...
class infrastructure_class extends db_connection{
	...
	*/
	...
	//-INSERT room--//
	public function addRoom_cls($hostelid,$roomname,$roomtype,$roomgender,$roomcap){
		//write query
		$roomstatus=0;
		$insertsql = "INSERT INTO rooms(hostel_id,room_name,room_type,room_gender,room_cap,room_status) VALUES ('$hostelid','$roomname','$roomtype','$roomgender','$roomcap','$roomstatus')";
	...
	//-update ROOM--//
	public function updateRoom_cls($editedname,$editedtype,$editedgender,$editedcap,$roomid){

		//write query
		$updatesql = " UPDATE rooms SET room_name='$editedname',room_type='$editedtype',
		room_gender='$editedgender',
		room_cap='$editedcap' WHERE room_id= '$roomid' ";
